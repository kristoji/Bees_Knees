...
def main():  # noqa: C901
    ...
    ap.add_argument('--k-min', type=int, default=20, help='Global minimum k (used if per-type not provided)')
    ap.add_argument('--k-max', type=int, default=20, help='Global maximum k (used if per-type not provided)')
    # Optional per-type overrides
    ap.add_argument('--board-k-min', type=int, default=20, help='Override minimum k for board embeddings')
    ap.add_argument('--board-k-max', type=int, default=20, help='Override maximum k for board embeddings')
    ap.add_argument('--move-k-min', type=int, default=20, help='Override minimum k for move embeddings')
    ap.add_argument('--move-k-max', type=int, default=20, help='Override maximum k for move embeddings')
